...
| [v1-self-service-onboarding.md](../../../docs/acceptance/v1-self-service-onboarding.md) | 自助注册 + key 签发 | 发版必跑 |
| [v1-api-key-lifecycle.md](../../../docs/acceptance/v1-api-key-lifecycle.md) | Keys UI/API | 发版必跑 |
| [v1-display-name-registration.md](../../../docs/acceptance/v1-display-name-registration.md) | 显示名 setup | 发版必跑 |
| [v1-library-write-buffer.md](../../../docs/acceptance/v1-library-write-buffer.md) | buffered 状态机 | 发版必跑 |
| [v1-user-portal.md](../../../docs/acceptance/v1-user-portal.md) | 历史 P1–P19 映射（只读归档） | — |
