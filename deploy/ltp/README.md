...
Database/user setup then runs against the detected port and passes the password
via psql variables rather than embedding the secret in shell-interpolated SQL.
