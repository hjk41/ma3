...
# Requires: docker, host networking, uvicorn on 127.0.0.1:8000 with MA3_METRICS_ENABLED=1,
# optional /etc/ma3/feishu.env for Alertmanager → Feishu.
#
...
echo "==> prometheus (host network, :9090 loopback)"
...
echo "OK: prometheus :9090  alertmanager :9093  grafana :3000 (all loopback)"
