...
| P6 | **Explicit quality states** | active / buffered / draft / invalid 等状态清晰 |
...
SaaS 多租户、Observatory、vector 搜索、维护者分层 — **v1 core**（见 [04-target-architecture.md](04-target-architecture.md)）。Billing 完整 UI、LTP legacy、eval harness — **非 v1 发布物或 v1.1+**。
