...
> **前置**：[08-kb-access-and-org-isolation.md](08-kb-access-and-org-isolation.md)  
> **状态**：设计定稿；**v1 未全量实现** — 当前以 `paid_principal_ids` 等启发式过渡（见 design/14 免费档 grant 锁定），schema/enforcement 按 Phase B1–B4 落地  
