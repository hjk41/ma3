...
> **前置**：[13-self-service-onboarding.md](13-self-service-onboarding.md)  
> **状态**：定稿（2026-07-04）；验收 [v1-api-key-lifecycle](../acceptance/v1-api-key-lifecycle.md)
...
- [13-self-service-onboarding.md](13-self-service-onboarding.md) — 首登建库 + 自助签发切片
- [08-kb-access-and-org-isolation.md](08-kb-access-and-org-isolation.md) — grants 模型
- [22-user-portal-ui-layout.md](22-user-portal-ui-layout.md) §3.7 — 顶栏 API Keys 入口
