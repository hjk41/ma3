...
> **ADR**：[ADR-011](../adr/011-kb-access-and-org-isolation.md)（personal-dev 切片）  
> **前置**：[08-kb-access](08-kb-access-and-org-isolation.md)、[10-write-audit](10-write-audit-and-delete.md)  
> **状态**：设计定稿（2026-07-04）；key 生命周期后续演进见 [14-api-key-lifecycle.md](14-api-key-lifecycle.md)  
> **验收**：[v1-self-service-onboarding](../acceptance/v1-self-service-onboarding.md)
...
| 文档 | 关系 |
|------|------|
| [14-api-key-lifecycle.md](14-api-key-lifecycle.md) | key 删除/改名/布局真源 |
| [17-display-name-registration.md](17-display-name-registration.md) | 首登 setup 门控 |
| [08-kb-access-and-org-isolation.md](08-kb-access-and-org-isolation.md) | ACL 全貌 |
| [10-write-audit-and-delete.md](10-write-audit-and-delete.md) | confirmation 语义 |
