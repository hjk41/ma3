...
- **Scope**: ratified [16-library-write-buffer-fable.md](../design/16-library-write-buffer-fable.md) + [16-library-write-buffer-decisions-for-owner.md](../design/16-library-write-buffer-decisions-for-owner.md) + layout [16-library-write-buffer-layout-fable.md](../design/16-library-write-buffer-layout-fable.md)
