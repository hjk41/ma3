...
> **参照**：[PITCH.md](../pitch/PITCH.md)、[00-vision.md](00-vision.md)、[15-user-portal-fable.md](15-user-portal-fable.md) §2.4、[22-user-portal-ui-unified-layout-fable.md](22-user-portal-ui-unified-layout-fable.md) §2.1、[13-self-service-onboarding.md](13-self-service-onboarding.md)  
> **i18n**：[all_docs/04-frontend/ui-i18n-design-gpt55.md](../all_docs/04-frontend/ui-i18n-design-gpt55.md) — v1 支持 `zh-CN` / `en-US`  
...
| 5 | 是否同步更新 `all_docs/04-frontend/information-architecture.md`？ | **实现后同步** — 站点地图加 `/ui/home/` |
