...
SaaS 多租户、Observatory、vector 搜索、维护者分层 — **v1 core**（见 [system-overview.md](../02-architecture/system-overview.md)）。Billing 完整 UI、LTP legacy、eval harness — **非 v1 发布物或 v1.1+**。
