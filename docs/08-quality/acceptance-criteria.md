...
| v1 | 自助 onboarding | [acceptance/v1-self-service-onboarding.md](acceptance/v1-self-service-onboarding.md) | 已有 |
| v1 | API Key 生命周期 | [acceptance/v1-api-key-lifecycle.md](acceptance/v1-api-key-lifecycle.md) | 已有 |
| v1 | 显示名注册 | [acceptance/v1-display-name-registration.md](acceptance/v1-display-name-registration.md) | 已有 |
| v1 | 用户门户 P1–P19（归档） | [acceptance/v1-user-portal.md](acceptance/v1-user-portal.md) | 映射至 v1-user-portal-ui |
| v1 | Write buffer | [acceptance/v1-library-write-buffer.md](acceptance/v1-library-write-buffer.md) | PASS-WITH-NITS |
| v1 | 个人开发者旅程 | [acceptance/v1-personal-developer-journey.md](acceptance/v1-personal-developer-journey.md) | 已有 |
...
- [ ] Agent 行为验收 T1–T5（[testing/release-agent-behavior-tests.md](../testing/release-agent-behavior-tests.md)）
