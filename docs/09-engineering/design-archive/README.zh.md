# design-archive — 决策摘要目录

本目录**仅保留各主题的「决策摘要」**文档，原始过程稿（设计草案、评审记录、视觉稿等）已压缩删除。

- 每个主题一份 `NN-<topic>-decisions.md`，记录：背景、已拍板决策、明确不做/否决项、落地位置、被压缩删除的历史稿清单。
- 本目录内容**非契约**：如与正式文档冲突，以 docs 正式层（`docs/` 各分层文档）与 ADR 为准。
