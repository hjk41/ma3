...
- [`docs/design/08-kb-access-and-org-isolation.md`](../design/08-kb-access-and-org-isolation.md) — 完整 schema 与分阶段实现
- [`docs/design/04-target-architecture-draft.md`](../design/04-target-architecture-draft.md) §2 auth 模块
- Pitch：[`docs/pitch/knowledge-management-pitch.md`](../pitch/knowledge-management-pitch.md)
