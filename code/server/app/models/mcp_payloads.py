...
from app.models.agent_types import AgentAction
...
class Ma3ContextPayload(BaseModel):
    ...
    client_version: str | None = Field(
        default=None,
        description=(
            "Optional ma3 client/plugin version (e.g. 4.0.0). When set, every tool "
            "response includes structuredContent.server with client_update_* hints."
        ),
    )
